...
REPO_URL="https://github.com/herschel21/tmux-configuration/archive/refs/heads/release-1.1.zip"
DOWNLOAD_DIR="temp_files/"
ZIP_FILE="$DOWNLOAD_DIR/release-1.1.zip"
...
cp "$DOWNLOAD_DIR/tmux-configuration-release-1.1/tmux.conf" "$CONFIG_FILE"
cp "$DOWNLOAD_DIR/tmux-configuration-release-1.1/tmux.conf.local" "$LOCAL_FILE"
